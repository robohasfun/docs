...
|---|---|---|
| **PredictionMarket** | [`0x728A...aFeAB`](https://basescan.org/address/0x728A94B26f443f60A558076D181B4081E71aFeAB) | Core market logic — challenge placement, pool management, payouts |
| **USDC** | [`0x8335...02913`](https://basescan.org/token/0x833589fCD6eDb6E08f4c7C32D4f71b54bdA02913) | Circle's native USDC on Base |

<Tip>
  You can verify any challenge or payout by looking up the transaction on [Basescan](https://basescan.org). Every interaction with the PredictionMarket contract is publicly visible.
</Tip>
